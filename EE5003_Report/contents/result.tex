...
\begin{table}[htbp]
    \centering
    \begin{tabular}{p{0.34\linewidth}c}
        \hline
        \textbf{Destination} & \textbf{Mean selection rate (\%)} \\
        \hline
        Local & 19.42 \\
        Edge 4 & 11.02 \\
        Edge 5 & 10.55 \\
        ...
        \hline
    \end{tabular}
    \caption{Average MAPPO destination-selection rates across seeds 9001, 9002, and 9003.}
    \label{tab:mappo-destination-rates}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{0.34\linewidth}c}
        \hline
        \textbf{PRB bin} & \textbf{Mean selection rate (\%)} \\
        \hline
        20\% & 37.02 \\
        40\% & 48.89 \\
        60\% & 0.00 \\
        ...
        \hline
    \end{tabular}
    \caption{Average MAPPO PRB-bin selection rates across the three evaluation seeds.}
    \label{tab:mappo-prb-rates}
\end{table}
