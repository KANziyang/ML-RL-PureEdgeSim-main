...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.22\linewidth}p{0.68\linewidth}}
        ...
        LOCAL & Restrict execution to the local tier \\
        ...
        \hline
        PPO & Use a learned shared policy to jointly choose the execution destination and PRB reservation, optimized for expected cumulative QoS-oriented reward. \\
        MAPPO & Use an agent-conditioned learned policy to jointly choose the execution destination and PRB reservation, optimized under CTDE for expected cumulative QoS-oriented reward. \\
        \hline
    \end{tabular}
