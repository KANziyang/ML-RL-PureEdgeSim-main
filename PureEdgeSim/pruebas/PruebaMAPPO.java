...
public class PruebaMAPPO extends MainApplication {
	private static final String DEFAULT_SETTINGS_PATH = "PureEdgeSim/pruebas/settings_mappo_5agents/";
	...
	public static void main(String[] args) {
		...
		System.out.println("PruebaMAPPO: settingsPath=" + settingsPath);
		System.out.println("PruebaMAPPO: outputPath=" + outputPath);
