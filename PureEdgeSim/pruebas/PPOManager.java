...
public class PPOManager extends AbstractRLManager {
	private static final String TRACE_DIR_PROP = "ppo.trajectory.dir";
	...
	public PPOManager(SimulationManager simulationManager, List<List<Integer>> orchestrationHistory, List<Vm> vmList) {
		super(simulationManager, true, "PPO");
		...
		this.traceWriter = new DeviceAgentTraceWriter(TRACE_DIR_PROP, Paths.get("PureEdgeSim", "pruebas", "ppo", "trajectory"),
				"ppo_trajectories", decisionSupport.getDestinationLabels());
