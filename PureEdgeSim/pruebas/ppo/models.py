...
class PPOActor(nn.Module):
    """Single-agent PPO actor for task offloading.

    Same architecture as MAPPO TurnActor but without agent_embedding.
    All tasks share one policy network regardless of which device generated them.
    """
    ...
    def encode(
        ...
        agent_hidden = self.agent_encoder(agent_obs)
    ...
    def act(
        ...
        agent_hidden, dest_hidden, dest_logits = self.encode(agent_obs, dest_features, dest_mask)
