...
public class PPONewManager extends AbstractRLManager {
	private static final String TRACE_DIR_PROP = "ppo_new.trajectory.dir";
	...
	public PPONewManager(SimulationManager simulationManager, List<List<Integer>> orchestrationHistory, List<Vm> vmList) {
		super(simulationManager, true, "PPO_NEW");
		this.decisionSupport = new DeviceAgentDecisionSupport(simulationManager, orchestrationHistory, vmList);
		this.traceWriter = new DeviceAgentTraceWriter(TRACE_DIR_PROP, Paths.get("PureEdgeSim", "pruebas", "ppo", "trajectory"),
				"ppo_new_trajectories", decisionSupport.getDestinationLabels());
